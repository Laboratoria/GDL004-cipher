...
function Cypher(){
    let letra = document.getElementById("mensaje").value;
    let numero = document.getElementById("numero").value;
    let resultadoCifrado = cipher.encode(letra, numero);
...
function Decipher(){
    let letra = document.getElementById("resultado").value;
    let numero = document.getElementById("numero").value;
    let password = document.getElementById("Password").value;
    //document.getElementById("resultado").value = i;
 // let mayusculas = i.toUpperCase();
    let mayusculas = cipher.decode(letra, numero, password);
